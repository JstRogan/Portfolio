...
export default function ProjectsPage() {
  ...
  if (loading) return <ProjectsPageLoading />;

  return (
    <main className="min-h-screen">
      <Navbar />
      <div className="pt-40 pb-20 px-6 max-w-6xl mx-auto">
        <ProjectsPageHeader title="All Projects" subtitle="A complete list of things I&apos;ve worked on, from personal experiments to full-stack applications." />
