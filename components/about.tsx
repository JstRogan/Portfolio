...
import { Code2, Globe2, Sparkles, Plus } from 'lucide-react';
          ...
          <div className="mt-auto">
            ...
            <div className="flex flex-wrap gap-2">
              {['React', 'Next.js', 'TypeScript', 'Node.js', 'Tailwind', 'WebGL'].map(tech => (
                <span key={tech} className="px-3 py-1.5 bg-zinc-50 dark:bg-[#151515] border border-zinc-200 dark:border-white/5 rounded-full text-xs font-mono text-zinc-600 dark:text-zinc-400 transition-colors duration-300">
                  {tech}
                </span>
              ))}
            </div>
